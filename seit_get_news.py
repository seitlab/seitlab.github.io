...
if __name__ == '__main__':
    ...
    html_string = '<div class="feature_article_img"><img class="img-responsive top_static_article_img" src="https://upload.wikimedia.org/wikipedia/commons/b/b6/Image_created_with_a_mobile_phone.png'+ '" alt="feature-top" width="100%"> </div> <div class="feature_article_inner"> <div class="tag_lg red">Hot Threat News</div> <div class="feature_article_title"> <h1><a href='+ html_link+ ' target="_self"> ' + html_title + ' </a></h1> </div> <div class="feature_article_date"><a href="#" target="_self"> '+ html_author +' </a>,<a href="#" target="_self"> '+ html_date + ' </a> </div> </div>'    
